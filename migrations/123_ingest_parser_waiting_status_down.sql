-- Rollback migration 123: remove parser_waiting status.
...
UPDATE ingest_pending
   SET status = 'queued'
 WHERE status = 'parser_waiting';

CREATE TABLE ingest_pending_new_123_down (
    id TEXT PRIMARY KEY,
...
INSERT INTO ingest_pending_new_123_down (
...
ALTER TABLE ingest_pending_new_123_down RENAME TO ingest_pending;
...
DELETE FROM schema_versions WHERE version = 123;
