-- Migration 126: allow terminal_upload ingest source kind.
-- v1.0.0 - 2026-05-15
--
-- SQLite cannot alter CHECK constraints in place, so rebuild ingest_pending
-- with the same columns and indexes while adding terminal_upload to source_kind.

PRAGMA foreign_keys=OFF;

BEGIN IMMEDIATE;

CREATE TABLE ingest_pending_new_126 (
    id TEXT PRIMARY KEY,
...
INSERT INTO ingest_pending_new_126 (
...
ALTER TABLE ingest_pending_new_126 RENAME TO ingest_pending;
...
INSERT OR IGNORE INTO schema_versions(version) VALUES (126);
