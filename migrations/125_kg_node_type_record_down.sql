-- Rollback migration 125: remove `record` from graph_nodes.type CHECK.
--
-- Precondition: no graph_nodes rows with type='record'. If they exist, move or
-- delete them before rollback.
...
CREATE TABLE graph_nodes_new (
    ...
    type TEXT NOT NULL CHECK(type IN (
        ...
        'inbox',
        'xlsx',
        'policy','contract','transcript','report'
    )),
    name TEXT NOT NULL,
...
DELETE FROM schema_versions WHERE version = 125;
