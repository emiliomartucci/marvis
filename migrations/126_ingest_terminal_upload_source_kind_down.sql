-- Rollback migration 126: remove terminal_upload source kind.
...
UPDATE ingest_pending
   SET source_kind = 'file_drop'
 WHERE source_kind = 'terminal_upload';

CREATE TABLE ingest_pending_new_126_down (
    id TEXT PRIMARY KEY,
...
INSERT INTO ingest_pending_new_126_down (
...
ALTER TABLE ingest_pending_new_126_down RENAME TO ingest_pending;
...
DELETE FROM schema_versions WHERE version = 126;
