-- Rollback per migration 102 (promote llm_costs, originally 100 — renumbered).
--
...
-- le colonne extra restano fisicamente in tabella ma il codice pre-102
...
DELETE FROM schema_versions WHERE version = 102;
