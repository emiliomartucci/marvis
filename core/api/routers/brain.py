...
# ---------------------------------------------------------------------------
# Wave 3.1 gap 7 — promote a Brain finding to a PiR task.
# ---------------------------------------------------------------------------
...
@router.post(
    ...
    summary="Promote a Brain finding to a PiR task (Wave 3.1 gap 7)",
)
async def promote_finding_to_task(
    ...
    """Convert a Brain finding into a tracked PiR task.
