...
export interface TranslationDictionary {
  appShell: {
    ...
    llmKeyMissingTitle: string;
    llmKeyMissingHint: string;
    llmKeyMissingLink: string;
    llmKeyMissingDismiss: string;
    llmKeyMissingDismissLabel: string;
  };
  onboarding: {
    stepCounter: string;
    steps: {
  ...
  todos: {
    ...
    decision: {
      title: string;
      sceltaPlaceholder: string;
      rationalePlaceholder: string;
      opzioniPlaceholder: string;
      submit: string;
    };
  };
  llmSettings: {
