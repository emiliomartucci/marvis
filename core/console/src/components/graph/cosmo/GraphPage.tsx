...
export function GraphPage() {
  ...
  if (data.projects.length === 0) {
    return (
      <div style={{ ...SHELL_STYLE, alignItems: "center", justifyContent: "center", padding: 24 }}>
        <section style={{ maxWidth: 420, textAlign: "center" }}>
          <h2 style={{ margin: 0, color: "var(--pir-text-primary)", fontSize: 18 }}>
            {t.graph.emptyTitle}
          </h2>
          <p style={{ margin: "10px 0 0", color: "var(--pir-text-secondary)", fontSize: 14 }}>
            {t.graph.emptyBody}
          </p>
          <p style={{ margin: "12px 0 0", color: "var(--pir-text-muted)", fontSize: 12 }}>
            {t.graph.emptyAction}
          </p>
        </section>
      </div>
