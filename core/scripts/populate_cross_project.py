...
_SIMILAR_TO_THRESHOLD_DEFAULTS: dict[str, float] = {
    ...
    "KG_SIMILAR_TO_THRESHOLD_VOYAGE": 0.75,
...
_SIMILAR_TO_THRESHOLD_ENV_BY_MODE: dict[str, str] = {
    "voyage": "KG_SIMILAR_TO_THRESHOLD_VOYAGE",
    "dual": "KG_SIMILAR_TO_THRESHOLD_VOYAGE",
...
def _compute_similar_to(
    ...
    """
    embedding_mode = os.environ.get("EMBEDDING_MODE", "voyage")
    active_threshold = (
