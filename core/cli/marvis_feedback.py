...
from core.platform import current_user
...
def _scrub_pii(text: str) -> str:
    ...
    # current_user() = pwd name on POSIX, getpass/USERNAME on Windows; os.getlogin
    # raised OSError on Windows with no controlling terminal (CI / service).
