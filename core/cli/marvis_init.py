...
# `marvis console` + `marvis autostart` — packaged local GUI launcher and opt-in
# OS startup for the local API.
from core.cli.marvis_console import register as _register_console  # noqa: E402
