...
> Beta for testers: **0.3.7b3**
> (`uv tool install 'marvisx-cli==0.3.7b3'`); stable installs stay on 0.3.6 until
> the final 0.3.7. (b3 makes code embeddings opt-in for #9; b2 completed the
> `doctor` projects_root fix for #4 and added the managed-Windows / WDAC install
> note.)
