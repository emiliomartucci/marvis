...
> Beta for testers: **0.3.7b2**
> (`uv tool install 'marvisx-cli==0.3.7b2'`); stable installs stay on 0.3.6 until
> the final 0.3.7. (b2 completes the `doctor` projects_root fix for #4 and adds
> the managed-Windows / WDAC install note.)
