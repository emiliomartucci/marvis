...
// `mac_gateway` is intentionally NOT offered here (gh #32): it is a personal
// setup, not an OSS product option. Custom gateways use `openai_compatible`
// (with a base_url). The LlmProvider type + PROVIDER_LABELS still carry it so an
// existing/managed key of that provider keeps rendering its label.
